<x-app>
    ...
    <div class="w-full justify-center flex">
        ...
        <div class="bg-white-200 p-6 w-8/12 rounded-lg text-center">
            ...
            <h1 class="text-4xl mb-8">Welcome to the tasks app</h1>
            @guest
            ...
            <p class="text-3xl fond-semibold mt-14">Go to the Tasks page, Set up task lists, mark them done or delete tasks from the list</p>
